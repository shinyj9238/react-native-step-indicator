...
export default class StepIndicator extends PureComponent {
    ...
    constructor(props) {
        ...
        const defaultStyles = {
            ...
            stepLabelUnFinishedColor: '#000000',
            stepLabelFinishedColor: '#000000',
    ...
    renderStepLabels = () => {
        ...
        var labelViews = labels.map((label, index) => {
            ...
            switch (this.getStepStatus(index)) {
                ...
                case STEP_STATUS.FINISHED: {
                    selectedStepLabelStyle = {color: this.customStyles.stepLabelFinishedColor,};
                    break;
                }
                case STEP_STATUS.UNFINISHED: {
                    selectedStepLabelStyle = {color: this.customStyles.stepLabelUnFinishedColor,};
                    break;
                }
                default:
            }
            ...
            return (
                <View style={styles.stepLabelItem} key={index}>
                    <Text style={[styles.stepLabel, selectedStepLabelStyle, {fontSize: this.customStyles.stepLabelFontSize}]}>
                        {label}
                    </Text>
                </View>
            );
        ...
        return (
            <View style={[styles.stepLabelsContainer, direction === 'vertical' ? {
                flexDirection: 'column',
                paddingHorizontal: 4,
